...
func TestRemoteConfigMD5UsesHeaderAndPreservesUpdateProxy(t *testing.T) {
	...
	body := []byte("collect_interval=0&report_interval=60&reset_day=1&schema_version=9&interface=&node_1=&node_2=&node_3=&node_4=&connection_mode=auto&ping_mode=icmp")

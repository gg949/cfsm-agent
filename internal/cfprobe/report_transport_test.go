...
func TestWSSConfigBodySupportsConfigBodyAndConfigObject(t *testing.T) {
	body, headers, ok := wssConfigBodyAndHeaders(wsServerFrame{
		Type:       "ack",
		ConfigBody: "collect_interval=0&report_interval=60&reset_day=1&schema_version=9&interface=&node_1=&node_2=&node_3=&node_4=&connection_mode=auto&ping_mode=tcp",
		ConfigMD5:  "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb",
	})
	if !ok {
		t.Fatal("config_body frame returned ok=false")
	}
	if string(body) != "collect_interval=0&report_interval=60&reset_day=1&schema_version=9&interface=&node_1=&node_2=&node_3=&node_4=&connection_mode=auto&ping_mode=tcp" {
...
func TestReportTransportWSSConfigAppliesRemoteConfig(t *testing.T) {
	...
	transport.handleConfigFrame(wsServerFrame{
		Type:      "config",
		Config:    "collect_interval=10&report_interval=120&wss_report_interval=4&reset_day=1&schema_version=9&interface=&node_1=&node_2=&node_3=&node_4=&connection_mode=auto&ping_mode=icmp",
		ConfigMD5: "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb",
	})
...
func TestReportTransportWSSConfigCanSwitchToHTTP(t *testing.T) {
	...
	transport.handleConfigFrame(wsServerFrame{
		Type:      "config",
		Config:    "collect_interval=0&report_interval=60&reset_day=1&schema_version=9&interface=&node_1=&node_2=&node_3=&node_4=&connection_mode=http&ping_mode=tcp",
		ConfigMD5: "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb",
	})
...
func TestReportTransportWSSConfigAllowsMissingMD5(t *testing.T) {
	...
	transport.handleConfigFrame(wsServerFrame{
		Type:   "config",
		Config: "collect_interval=0&report_interval=120&reset_day=1&schema_version=9&interface=&node_1=&node_2=&node_3=&node_4=&connection_mode=auto&ping_mode=tcp",
	})
...
func TestReportTransportWSSConfigThrottlesToOneMinute(t *testing.T) {
	...
	transport.handleConfigFrame(wsServerFrame{
		Type:   "config",
		Config: "collect_interval=0&report_interval=180&reset_day=1&schema_version=9&interface=&node_1=&node_2=&node_3=&node_4=&connection_mode=auto&ping_mode=tcp",
	})
	if agent.cfg.ReportInterval != 120 {
